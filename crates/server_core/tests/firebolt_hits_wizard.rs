...
fn firebolt_hits_wizard_reliably() {
    unsafe { std::env::set_var("RA_SKIP_CAST_GATING", "1"); }
    ...
    s.spawn_projectile_from_pc(pc, Vec3::new(0.0, 0.0, 1.0), server_core::ProjKind::Firebolt);
