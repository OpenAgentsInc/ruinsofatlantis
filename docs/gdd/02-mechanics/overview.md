...
- Wishcrafting (profession): design → bind → simulate → adjudicate → commit high‑impact, rules‑bound wishes with guardrails (Paradox Heat, Anchor Invariants). See wishcrafting.md.
