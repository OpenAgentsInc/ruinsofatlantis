<!-- Source: docs/srd/SRD_CC_v5.2.1.pdf pp.314–317 -->
...
Pirate
      ...
      Throw: DC 21. Failure: The target has the Poisoned           Holy Burst. Dexterity Saving Throw: DC 20, each encondition. While Poisoned, the target can’t regain Hit       emy in a 20-foot-radius Sphere centered on a point the
      Points and takes 21 (6d6) Poison damage at the start of      planetar can see within 120 feet. Failure: 24 (7d6) Radieach of its turns, and it repeats the save at the end of     ant damage. Success: Half damage.
      ...
      as Spellcasting.                                            Magic Resistance. The pseudodragon has Advantage on saving throws against spells and other magi-
      Priest                                                      cal effects.
      ...
      to three creatures swallowed at a time). Failure: The tarft.), or a toad (40 ft., Swim 40 ft.), or it returns to its
      get is swallowed by the worm, and the Grappled contrue form. Its game statistics are the same in each form,
