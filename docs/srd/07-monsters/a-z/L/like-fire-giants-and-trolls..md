...
<!-- Auto-extracted; needs review -->

```text
                                                                  like fire giants and trolls.
      Name and General Details. The name of the mon-            Humanoids are people defined by their roles and
       ster is followed by its size, creature type (along         professions, such as mages, pirates, and warriors.
       with any descriptive tags), and alignment.                 They include members of varied species.
      Combat Highlights. Armor Class, Hit Points, Speed,        Monstrosities are unnatural creatures with
       and Initiative are provided here.                          strange origins, such as mimics and owlbears.
      Ability Scores. A monster’s ability scores, ability       Oozes are gelatinous creatures, including black
       modifiers, and saving throws are listed here.              puddings and gelatinous cubes.
      Other Details. The monster’s Senses, Languages,           Plants are sentient vegetation and fungal monsters,
       and CR entries appear here. Additional details ap-         such as shambling mounds and treants.
       pear in some monsters, such as skill proficiencies,      Undead are spirits and the reanimated dead, such
       Resistances, Immunities, and Gear. If a monster            as ghosts, vampires, and zombies.
       lacks those details, entries for them don’t appear.
      Traits. Monster characteristics that are active at all    Descriptive Tags
       times or during certain situations appear here.          A monster might have one or more tags in parenthe-
      Actions. The monster can take the actions here in         ses following its type. Such tags provide additional
       addition to those in “Playing the Game.”                 categorization and have no rules of their own, but
      Bonus Actions. This section provides a monster’s          certain game effects might refer to them.
       Bonus Actions, if any.                                   Alignment
      Reactions and Legendary Actions. These sections
       provide Reactions and Legendary Actions, if any.         The alignment specified in a monster’s stat block is
                                                                a default suggestion of how to roleplay the monster,
      Parts of a Stat Block                                     inspired by its traditional role in the game or real-​
                                                                world folklore. Change a monster’s alignment to
      The rules for a stat block are detailed in “Rules Glos-   suit your storytelling needs. The Neutral alignment,
      sary” and in this section.                                in particular, is an invitation for you to consider
      Size                                                      whether an individual leans toward one of the other
                                                                alignments.
      A monster is Tiny, Small, Medium, Large, Huge,              “Character Creation” describes the nine align-
      or Gargantuan. If size options are presented, you         ments and unaligned creatures.
      choose the creature’s size from those options. See
      “Playing the Game” for information on size.               Armor Class
      Creature Type                                             A monster’s Armor Class (AC) includes its natural
                                                                armor, Dexterity, gear, and other defenses. See
      Each monster has a tag that identifies the type of        “Playing the Game” for information on Armor Class.
      creature it is. Certain spells, magic items, class fea-
      tures, and other effects in the game interact in spe-     Initiative
      cial ways with creatures of a particular type.            The Initiative entry specifies the monster’s Initia-
        The game includes the following creature types,         tive modifier followed by the monster’s Initiative
      which have no rules of their own:                         score in parentheses. Use the modifier when you
      Aberrations are utterly alien beings, such as abo-        roll to determine a monster’s Initiative. A monster’s
       leths and cloakers.                                      Initiative modifier is typically equal to its Dexterity
      Beasts are non-Humanoid natural creatures, like           modifier, but some monsters have additional mod-
       horses and wolves, as well as most giant animals.        ifiers, such as Proficiency Bonus, applied to that
      Celestials are magical creatures, such as angels and      number.
       pegasi, with ties to the Upper Planes.                      If you don’t want to roll a monster’s Initiative, use
      Constructs are magically created creatures such as        the Initiative score as the monster’s Initiative in
       homunculi and shield guardians.                          combat. Initiative is further detailed in “Playing the
      Dragons are scaly beings of ancient origin, such as       Game.”
       red dragons and wyverns.


254   System Reference Document 5.2.1

      Hit Points                                                 Running a Monster
      A monster’s Hit Points are presented as a number           To ensure a monster acts in accordance with its
      followed by parentheses, where the monster’s Hit           Challenge Rating, follow these rules during combat:
      Point Dice are provided, along with any contribu-          Special Abilities. If the monster has a special abil-
      tion from its Constitution. Either use the number for       ity that deals a lot of damage but has a limited
      the monster’s Hit Points or roll the die expression in      number of uses, such as a recharging breath
      parentheses to determine the monster’s Hit Points           weapon or a spell it can cast only once per day,
      randomly; don’t use both.                                   have it use that special ability as quickly and as
        A monster’s size typically determines the die used        often as possible.
      to calculate its Hit Points, as shown in the Hit Dice      Multiattack. If the monster has Multiattack, have
      by Size table.                                              it use Multiattack on any of its turns in which
                                                                  it’s not using one of its more powerful abilities.
      Hit Dice by Size
                                                                 Bonus Actions, Reactions, Legendary Actions. If
      Monster Size       Hit Die      Average HP per Die          the monster has Bonus Actions, Reactions, or
      Tiny                 d4                  2½                 Legendary Actions in its stat block, make sure it
      Small                d6                  3½                 uses them as often as it can.
      Medium               d8                  4½
      Large                d10                 5½
                                                               Immunities
      Huge                 d12                 6½              This entry lists the monster’s Immunities, if any. If
                                                               the monster has damage and condition Immunities,
      Gargantuan           d20                10½
                                                               the damage types are listed before the conditions.
      A monster’s Constitution modifier is multiplied by       See “Playing the Game” for details.
      the number of Hit Dice it possesses, and the result
      is added to its Hit Points. For example, if a monster
                                                               Gear
      has a Constitution of 12 (+1 modifier) and 2d8 Hit       Monsters have proficiency with their equipment. If
      Dice, it has 2d8 + 2 Hit Points (average 11).            a monster has equipment that can be given away or
        For more on Hit Points, see “Playing the Game.”        retrieved, the items are listed in the Gear entry. The
                                                               monster’s stat block might include special flour-
      Speed                                                    ishes that happen when the monster uses an item,
      The Speed entry specifies a monster’s Speed. Some        and the stat block might ignore the rules in “Equip-
      monsters have one or more of the following speeds:       ment” for that item. When used by someone else, a
      Burrow, Climb, Fly, Swim. Rules for Speed and these      retrievable item uses its “Equipment” rules, ignor-
      specials speeds appear in “Rules Glossary.”              ing any special flourishes in the stat block.
                                                                 The Gear entry doesn’t necessarily list all of a
      Ability Scores                                           monster’s equipment. For example, a monster that
      Every monster has six ability scores along with          wears clothes is assumed to be dressed appropri-
      corresponding ability score modifiers and saving         ately, and those clothes aren’t in this entry.
      throw modifiers. For more information on ability           Equipment mentioned outside the Gear entry is
      scores and saving throws, see “Playing the Game.”        considered to be supernatural or highly specialized,
                                                               and it is unusable when the monster is defeated.
      Skills
                                                               Ammunition and Ranged Attacks
      The Skills entry specifies a monster’s skill profi-      A monster that requires ammunition to make
      ciencies, if any. For example, a monster that is very    ranged attacks carries the necessary ammunition.
      perceptive and stealthy might have bonuses to Wis-
      dom (Perception) and Dexterity (Stealth) checks. A       Equipping a Monster with Other Items
      skill bonus is the sum of a monster’s relevant ability   You may equip monsters with additional gear how-
      modifier and its Proficiency Bonus. Other modifiers      ever you like, using the items in “Equipment” for
      might apply.                                             inspiration. You decide how much of a monster’s
                                                               equipment is recoverable after the creature is slain
      Resistances and Vulnerabilities                          and whether any of that equipment is still usable.
      These entries list a monster’s Resistances and Vul-        Beware of giving a monster combat-oriented
      nerabilities, if any. See “Playing the Game” for more    magic items, since those might alter the monster’s
      information.                                             Challenge Rating. If you do give a monster a magic
...
255   System Reference Document 5.2.1
      ...
      a class tag after its creature type is considered a         CR           XP              CR            XP
      member of that class for Attunement purposes.
                                                                   11         7,200            28         120,000
      Senses                                                      12          8,400            29         135,000
      The Senses entry specifies a monster’s Passive              13         10,000            30         155,000
      Perception score, as well as any special senses the
      monster possesses. Passive Perception and special       Proficiency Bonus
      senses are described in “Rules Glossary.”               A monster’s Proficiency Bonus (PB) is determined
                                                              by its CR, as shown in the Proficiency Bonus by
      Languages                                               Challenge Rating table, and is reflected in saving
      This entry lists languages that the monster can use     throws, skills, and other statistics where the mon-
      to communicate. Sometimes a monster can under-          ster’s exceptional aptitude is a factor.
      stand a language but can’t communicate with it,
      which is noted in its entry. “None” indicates that a    Proficiency Bonus by Challenge Rating
      creature doesn’t comprehend any language.                   CR            PB             CR            PB
      Telepathy                                                   0–4           +2            17–20          +6
      Telepathy is a magical ability that allows a creature       5–8           +3            21–24          +7
      to communicate mentally with another creature              9–12           +4           25–28           +8
      within a specified range. See “Rules Glossary” for
                                                                 13–16          +5           29–30           +9
      more information.

      Challenge Rating                                        Traits
      Challenge Rating is defined in “Rules Glossary,”        A monster’s traits, if any, are features that are ac-
      while guidance on using CR to plan potential com-       tive at all times or in certain situations.
      bat encounters is in “Gameplay Toolbox.”
                                                              Actions
      Experience Points                                       A monster can take the actions in this section or
      The number of Experience Points (XP) a monster          take one of the actions available to all creatures, as
      is worth is based on its CR, as detailed in the Ex-     described in “Playing the Game.”
      perience Points by Challenge Rating table. XP is
      awarded for defeating the monster in combat or          Attack Notation
      otherwise neutralizing it.                              The entry for a monster’s attack identifies whether
        Unless a rule says otherwise, a monster sum-          the attack is a melee or a ranged attack and then
      moned by a spell or another magical ability is worth    provides the attack roll’s bonus, its reach or range,
      the XP noted in its stat block.                         and what happens on a hit. An attack is against one
                                                              target unless its entry says otherwise. For details
      Experience Points by Challenge Rating                   on different kinds of attacks, see “Playing the Game”
          CR           XP             CR            XP        and “Spells.”
                                                                Hit. Any damage dealt or other effects that occur
           0         0 or 10          14          11,500
                                                              as a result of an attack hitting a target are described
          1/8          25             15          13,000      after the “Hit:” notation.
          1/4          50             16          15,000        Miss. If an attack has an effect that occurs on a
          1/2          100            17          18,000      miss, that information follows the “Miss:” notation.
                                                                Hit or Miss. If an attack has an effect that occurs
           1          200             18          20,000
                                                              regardless of whether it hits or misses its target,
           2           450            19          22,000      that information follows the “Hit or Miss:” notation.
           3           700            20          25,000
                                                              Saving Throw Effect Notation
           4          1,100           21          33,000      If an effect forces a saving throw, the effect identi-
           5          1,800           22          41,000      fies the kind of save required and then provides the
           6          2,300           23          50,000      save’s DC, a description of which creatures make
           7          2,900           24          62,000
                                                              the save, and an explanation of what happens on a
                                                              failed or successful save.
           8          3,900           25          75,000         “Half damage only” on a successful save means
           9          5,000           26          90,000      the target takes half as much damage (round down)
          10          5,900           27         105,000      as targets that fail the save, while also ignoring all
                                                              other parts of the effect.


256   System Reference Document 5.2.1

      Damage Notation                                              Reactions
      ...
      expression in parentheses; don’t use both.                   Legendary Actions
      Multiattack                                                  If the monster has Legendary Action options, those
      Some creatures can make more than one attack                 are listed in this section. A Legendary Action is an
      when they take the Attack action. Such creatures             action that a monster can take immediately after
      have the Multiattack entry in the “Actions” section          another creature’s turn. Only one of these actions
      of their stat block. This entry details the attacks a        can be taken at a time and only after another crea-
      creature can make, as well as any additional abili-          ture’s turn ends. The monster can’t take a Legend-
      ties it can use, as part of the Attack action.               ary Action if it has the Incapacitated condition or is
                                                                   otherwise unable to take actions.
      Spellcasting                                                    The monster has a limited number of Legendary
      If a monster can cast any spells, its stat block lists       Action uses, and that number is specified in the
      the spells and provides the monster’s spellcasting           stat block. The monster expends one use whenever
      ability, spell save DC (if any spells require a saving       it takes a Legendary Action, and it regains all ex-
      throw), and spell attack bonus (if any spells require        pended uses at the start of each of its turns.
      an attack roll). Unless noted otherwise, a spell of
      level 1 or higher is always cast at its lowest possible      Limited Usage
      level and can’t be cast at a higher level.                   Some parts of a stat block have restrictions on the
         A monster’s spell can have special rules or restric-      number of times they can be used. Here are the
      tions. For example, a green hag can cast the Invisi-         most common ways that usage is limited:
      bility spell, but the spell has a “self only” restriction,
      which means the spell affects only the hag.                  X/Day. This notation means the stat block part can
         Spell Components. The Spellcasting trait notes             be used a certain number of times (represented
      whether the monster’s spellcasting ignores the                by X) and that a monster must finish a Long Rest
      need for certain spell components. If any spell com-          to regain expended uses. For example, a Reaction
      ponents are required, describe the monster’s use of           that includes “1/Day” means the Reaction can be
      Verbal, Somatic, or Material components to signal to          taken once and that the monster must finish a
      characters that it is casting a spell. A monster that         Long Rest to take it again.
      requires Material components has them.                       Recharge X–Y. This notation means a monster
         Casting Times of 1+ Minutes. If a spell has a cast-        can use the stat block part once. At the start of
      ing time of 1 minute or more yet is listed in a spell-        each of the monster’s turns, roll 1d6. If the roll
      casting action, the monster doesn’t cast the spell in         is within the number range given in the notation
      just one action unless the action’s description states        (represented by X–Y), the monster regains the use
      otherwise; the monster must take the Magic action             of that part, which also recharges when the mon-
      on each of its turns and maintain Concentration to            ster finishes a Short or Long Rest. For example,
      cast the spell, as described in “Rules Glossary.”             “Recharge 5–6” in an action means a monster can
                                                                    take the action once. Then, at the start of each of
      Bonus Action                                                  the monster’s turns, it regains the use of that ac-
      If a monster has Bonus Action options, they are               tion if it rolls a 5 or 6 on 1d6.
      listed in this section. See “Playing the Game” for de-       Recharge after a Short or Long Rest. This nota-
      tails on Bonus Actions.                                       tion means the monster can use the stat block
...
263   System Reference Document 5.2.1
      ...
      Int 12 +1 +1          Wis 11 +0 +3         Cha 15 +2 +2      DC 18, each creature in a 60-foot-long, 5-foot-
...
264   System Reference Document 5.2.1
      ...
      Ancient Black Dragon                                          Pounce. The dragon moves up to half its Speed, and it
                                                                    makes one Rend attack.
      ...
      Legendary Actions                                             10 ft. Hit: 17 (4d6 + 3) Acid damage. Nonmagical ar-
      ...
      on saving throws to maintain Concentration until the          and has 10+ Hit Points, it becomes Bloodied or is sub-
      end of its next turn. Failure or Success: The dragon can’t    jected to Lightning or Slashing damage. Response: The
...
286   System Reference Document 5.2.1
      ...
      Ghast                                                        Terrain. It takes 5 (1d10) Force damage if it ends its turn
...
287   System Reference Document 5.2.1
      ...
      Ghoul                                                          domly determined creature within its reach or does
...
288   System Reference Document 5.2.1
      ...
      Glabrezu                                                               MOD SAVE
                                                                   Str 18 +4 +7
                                                                                        ...
                                                                                        Dex 15 +2 +5
                                                                                                                     MOD SAVE
                                                                                                            Con 16 +3 +6
      Glabrezu                                                     Int 10 +0 +0         Wis 12 +1 +4        Cha 15 +2 +2
      ...
      Actions                                                      Gnoll
      Multiattack. The glabrezu makes two Pincer attacks           Gnoll Warrior
...
321   System Reference Document 5.2.1
      ...
      Sea Hag                                                      Resistances Acid, Cold, Fire, Lightning, Thunder
...
322   System Reference Document 5.2.1
      ...
      Shambling Mound                                              Senses Blindsight 10 ft., Darkvision 60 ft.;
...
323   System Reference Document 5.2.1
      ...
      Silver Dragon Wyrmling                                         Throw: DC 17, each creature in a 30-foot Cone. Failure:
      ...
      on a success. After 1 minute, it succeeds automatically.
                                                                     Actions
      Young Silver Dragon                                            Multiattack. The dragon makes three Rend attacks.
...
324   System Reference Document 5.2.1
      ...
      makes one Rend attack.                                        take one of the following actions. The dragon regains all
                                                                    expended uses at the start of each of its turns.
      Ancient Silver Dragon                                         Chill. The dragon uses Spellcasting to cast Hold Mon-
...
334   System Reference Document 5.2.1
      ...
      Vampire                                                         plus 7 (2d6) Necrotic damage. If the target is a Large or
...
336   System Reference Document 5.2.1
      ...
      Warrior Veteran                                                Slam. Melee Attack Roll: +7, reach 5 ft. Hit: 13 (2d8
      ...
      Water Elemental                                                Gear Handaxes (4)
                                                                     Senses Darkvision 60 ft.; Passive Perception 17
