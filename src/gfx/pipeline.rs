...
pub fn create_pipelines(
    ...
    let pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
        ...
        vertex: VertexState { module: shader, entry_point: Some("vs_main"), buffers: &[Vertex::LAYOUT], compilation_options: Default::default() },
    ...
    let inst_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
        ...
        layout: Some(&pipeline_layout),
        vertex: VertexState { module: shader, entry_point: Some("vs_inst"), buffers: &[Vertex::LAYOUT, Instance::LAYOUT], compilation_options: Default::default() },
...
pub fn create_wizard_simple_pipeline(
    ...
    device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
        ...
        layout: Some(&layout),
        vertex: VertexState { module: &shader, entry_point: Some("vs_main"), buffers: &[VertexPosUv::LAYOUT, Instance::LAYOUT], compilation_options: Default::default() },
        fragment: Some(FragmentState { module: &shader, entry_point: Some("fs_main"), targets: &[Some(ColorTargetState { format: color_format, blend: Some(wgpu::BlendState::ALPHA_BLENDING), write_mask: wgpu::ColorWrites::ALL })], compilation_options: Default::default() }),
        primitive: wgpu::PrimitiveState::default(),
